...
- **Outliers** have leverage proportional to $(x_i - \bar x)^2$: one crash day can set the beta by itself. Winsorise, or at least look at the leverage.
